...
### Кто я
- Backend-инженер: TypeScript/Node.js, Python, Lua, C#, API (REST/GraphQL), очереди, SQL/NoSQL.
- Инфосек-энтузиаст: атакую, чтобы защищать; CTF, сетевые векторы, безопасные протоколы.
- Люблю превращать хаос требований в чистый код и наблюдаемые сервисы.

### Чем занят сейчас
- Укрепляю безопасность API и инфраструктуры, разбираю пентест-лабы.
- Строю pet-сервисы: телеметрия/логирование, стриминг событий, утилиты для реверса.
